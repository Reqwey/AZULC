...
pub struct Launcher {
    ...
    pub(crate) java_detecting: bool,
    pub(crate) instance_java_requirement: Option<(Uuid, Result<u32, String>)>,
    java_requirement_request: u64,
...
impl Launcher {
    pub fn new() -> (Self, Task<Message>) {
        ...
        let app = Self {
            ...
            java_detecting: true,
            instance_java_requirement: None,
            java_requirement_request: 0,
